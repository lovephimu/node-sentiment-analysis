...
exports.default = (0, createRule_1.createRule)({
    ...
    create(context, [options]) {
        ...
        function determineNode(originalNode) {
            ...
            if (nodeToEvaluate.type === experimental_utils_1.TSESTree.AST_NODE_TYPES.ChainExpression) {
                nodeToEvaluate = nodeToEvaluate.expression;
            }
            if (nodeToEvaluate.type === experimental_utils_1.TSESTree.AST_NODE_TYPES.MemberExpression &&
                nodeToEvaluate.property.type !==
                    experimental_utils_1.TSESTree.AST_NODE_TYPES.PrivateIdentifier) {
